...
public class App {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new App().createAndShowUI());
    }
    ...
    private static Font loadUiFont() {
        try (InputStream fontStream = App.class.getResourceAsStream(CUSTOM_FONT_RESOURCE)) {
            if (fontStream != null) {
    ...
    private synchronized void startAutomation(String url) {
        stopAutomation();
        driver = getWebDriver();
        driver.get(url);
